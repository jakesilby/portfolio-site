...
> **[VISUAL — high priority, STATIC]** The full assessment page: section nav on the left, form in the center, Global Inline Drawer (completed assessments) on the right, so a reader can see the scope of a "full clinical assessment" at a glance.
